  ...
  return (
    <main>
      <div className="div__card">
       ...
       <button className="btn__accordion"><img src={arrow_icon} alt="" id='icon_1'></img></button>
      ...
      <button className="btn__accordion"><img src={arrow_icon} alt="" id='icon_2'></img></button>
      ...
      <button className="btn__accordion"><img src={arrow_icon} alt="" id='icon_3'></img></button>
      ...
      <button className="btn__accordion"><img src={arrow_icon} alt="" id='icon_4'></img></button>
      ...
      <button className="btn__accordion"><img src={arrow_icon} alt="" id='icon_5'></img></button>
